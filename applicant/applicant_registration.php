        ...
        <nav class="navbar" id="insidenav">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#">Applicant Registraation</a></li>
...
<div class="container">
    ...
    <h3 class="h3style">Login Detials </h3>
     ...
     <div class="form-group">
        <div class="col-sm-4">
             <input type="email" name="useremail" placeholder="E-mail Address" class="form-control" id="email">
        </div>
        <label class="error" ></label>
     </div>  

     <div class="form-group"> 
         <div class="col-sm-4">  <input type="password" id="passnew" placeholder="Password" name="pass1" class="form-control">
         </div>
        <label class="error"></label>
    </div>
   ...
   <div class="form-group">
                <div class="col-sm-4">
                    <input type="text" id="name" placeholder="Full Name" name="uname" class="form-control"> 
                </div>
         <label class="error"></label>
    </div>
